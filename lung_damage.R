...
pacman::p_load(cowplot, tidyverse, haven, estimatr, stargazer, tidylog, huxtable, flextable, ggrepel)
...
# Initialize table
common_results_table <- data.frame(matrix(ncol = 3, nrow = 2+ 5*3 + 5*(3-1) + 2 ))
names(common_results_table) <- c("", "OLS", "Poisson (mfx)")

# Using OLS
compare_all_ols <- lm_robust(cases_per_million ~ I(rm == 1) + I(mm == 1 & rm == 0), data = marijuana_data, se_type = "stata")

compare_all_ols$coefficients[1]
compare_all_ols$std.error[1]
compare_all_ols$p.value[1]
compare_all_ols$conf.low[1]
compare_all_ols$conf.high[1]

compare_all_ols$coefficients[2]
compare_all_ols$std.error[2]
compare_all_ols$p.value[2]
compare_all_ols$conf.low[2]
compare_all_ols$conf.high[2]

compare_all_ols$coefficients[3]
compare_all_ols$std.error[3]
compare_all_ols$p.value[3]
compare_all_ols$conf.low[3]
compare_all_ols$conf.high[3]

# Using Poisson count model
compare_all_poisson <-poissonmfx(round(mid_point) ~  I(rm == 1) + I(mm == 1 & rm == 0) + offset(log(pop_total/1000000)), data = marijuana_data)
# Recreational marijuana adoption is associated with -3.05 per million (roughly 40% of mean) 

compare_all_poisson$mfxest[1,1]
compare_all_poisson$mfxest[1,2]
compare_all_poisson$mfxest[1,4]
compare_all_poisson$mfxest[1,1] - qt(0.975, compare_all_poisson[["fit"]][["df.residual"]] -1)*compare_all_poisson$mfxest[1,2]
compare_all_poisson$mfxest[1,1] + qt(0.975, compare_all_poisson[["fit"]][["df.residual"]] -1)*compare_all_poisson$mfxest[1,2]


compare_all_poisson$mfxest[2,1]
compare_all_poisson$mfxest[2,2]
compare_all_poisson$mfxest[2,4]
compare_all_poisson$mfxest[2,1] - qt(0.975, compare_all_poisson[["fit"]][["df.residual"]] -1)*compare_all_poisson$mfxest[1,2]
compare_all_poisson$mfxest[2,1] + qt(0.975, compare_all_poisson[["fit"]][["df.residual"]] -1)*compare_all_poisson$mfxest[1,2]

huxreg(compare_all_poisson)
...
ggsave("~/Documents/GitHub/evali_and_recreational_marijuana/exhibit_1a.pdf", plot = combined_plot,dpi = 1200, width = 6, height = 15, units = "in")
ggsave("~/Documents/GitHub/evali_and_recreational_marijuana/exhibit_1a.png", plot = combined_plot,dpi = 1200, width = 6, height = 15, units = "in")
...
combined_plot_ecig
ggsave("~/Documents/GitHub/evali_and_recreational_marijuana/exhibit_1b.pdf", plot = combined_plot_ecig,dpi = 1200, width = 6, height = 15, units = "in")
ggsave("~/Documents/GitHub/evali_and_recreational_marijuana/exhibit_1b.png", plot = combined_plot_ecig,dpi = 1200, width = 6, height = 15, units = "in")
...
ggsave("~/Documents/GitHub/evali_and_recreational_marijuana/exhibit_1a_with_bars.pdf", plot = combined_plot_with_bars,dpi = 1200, width = 6, height = 15, units = "in")
ggsave("~/Documents/GitHub/evali_and_recreational_marijuana/exhibit_1a_with_bars.png", plot = combined_plot_with_bars,dpi = 1200, width = 6, height = 15, units = "in")
...
ggsave("~/Documents/GitHub/evali_and_recreational_marijuana/exhibit_1b_with_bars.pdf", plot = combined_plot_ecig_with_bars,dpi = 1200, width = 6, height = 15, units = "in")
ggsave("~/Documents/GitHub/evali_and_recreational_marijuana/exhibit_1b_with_bars.png", plot = combined_plot_ecig_with_bars,dpi = 1200, width = 6, height = 15, units = "in")
...
combine_both_plot_with_bars <- plot_grid(combined_plot_with_bars, combined_plot_ecig_with_bars, 
                               ...
                               rel_heights = c(1,1))
combine_both_plot
ggsave("~/Documents/GitHub/evali_and_recreational_marijuana/main_exhibit_with_bars.pdf", plot = combine_both_plot_with_bars,dpi = 1200, width = 12, height = 15, units = "in")
ggsave("~/Documents/GitHub/evali_and_recreational_marijuana/main_exhibit_with_bars.png", plot = combine_both_plot_with_bars,dpi = 300, width = 12, height = 15, units = "in")
...
print(my_doc, target =
        "/Users/hollina/Documents/GitHub/evali_and_recreational_marijuana/evali_and_ecig.docx")
